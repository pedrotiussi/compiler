...
class SemanticAnalyzer():
    ...
    def analyze(self):
        ...
        if self.rule == IDD_RULE:
            ...
            if IS_TYPE_KIND(self.p.eKind) or self.p.eKind==UNIVERSAL_:
                T_ = t_attrib(T,self.p._.nSize,T(self.p))
            else:
            ...
            while self.p!= None and self.p.eKind == NO_KIND_DEF_:
                self.p.eKind = VAR_
                self.p._ = Var(t,n,T_.nSize)
                n+=T_.nSize
                self.p= self.p.pNext
            ...
            n = NUM_._.val
            t = T_._.type
            self.p.eKind = ARRAY_TYPE_
            self.p._ = Array(t,n,n*T_.nSize)
            ...
            self.p= IDD_._.object
            t = T_._.type
            self.p.eKind = ALIAS_TYPE_
            self.p._ = Alias(t,T_.nSize)
            ...
            IDD_ = semantic_stack.pop()
            self.p= IDD_._.object
            self.p.eKind = STRUCT_TYPE_
            self.p._ = Struct(DC_._.list,DC_.nSize)
            EndBlock()
            ...
            self.p= IDD_._.object
            self.p.eKind = PARAM_
            self.p._ = Param(t,0,T_.nSize)
            LP_ = t_attrib(LP,T_.nSize,LP(self.p))
            ...
            curFunction = f
            self.generated_code.write(f"BEGIN_FUNC {f._.nIndex} {f._.nParams}\n")
            ...
            if t.eKind != STRUCT_TYPE_:
                ...
                if self.p == None:
                    ...
                    LV0_ = t_attrib(LV,None,LV(self.p._.pType))
                    LV0_._.type._ = Type(None,self.p._.nSize)
            semantic_stack.append(LV0_)
            self.generated_code.write(f"\tADD {self.p._.nIndex}\n")
            ...
            IDU_ = semantic_stack.pop()
            self.p = IDU_._.object
            if self.p.eKind != VAR_ and self.p.eKind!=PARAM_:
                if self.p.eKind != UNIVERSAL_:
                    Error(self.lexical, ERR_KIND_NOT_VAR)
                LV_ = t_attrib(LV,None,LV(universal_))
            else:
                LV_ = t_attrib(LV,None,LV(self.p._.pType))
                LV_._.type._ = Type(None,self.p._.nSize)
                self.generated_code.write(f"\tLOAD_REF {self.p._.nIndex}\n")
            ...
            if not LE_._.err:
                if LE_._.n-1 < f._nParams and LE_._.n != 0:
                    ...
                    Error(self.lexical, ERR_TOO_MANY_ARG)
            semantic_stack.append(F_)
            self.generated_code.write(f"\tCALL {f._.nIndex}\n")
            ...
            if t._ == None or t._.nSize == None:
                ...
                self.generated_code.write(f"\tSTORE_REF {t._.nSize}\n")
